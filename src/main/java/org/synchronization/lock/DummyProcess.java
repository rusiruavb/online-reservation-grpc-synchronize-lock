...
public class DummyProcess {
    ...
    public static void main(String[] args) {
        ...
        } catch (IOException | KeeperException |
    ...
    private static void accessSharedResource() throws
        ...
        Random r = new Random();
        long sleepDuration = Math.abs(r.nextInt() % 20); System.out.println("Accessing critical section. Time remaining : " + sleepDuration + " seconds.");
        Thread.sleep(sleepDuration * 1000);
    }
    private static String getCurrentTimeStamp() { return timeFormat.format(new
